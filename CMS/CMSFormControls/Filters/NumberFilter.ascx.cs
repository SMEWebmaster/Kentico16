...
public partial class CMSFormControls_Filters_NumberFilter : FormEngineUserControl
{
    ...
    public override string GetWhereCondition()
    {
        ...
        // No condition
        if (String.IsNullOrWhiteSpace(value) || String.IsNullOrEmpty(op) || !ValidationHelper.IsDouble(value))
        {
            return null;
        }
        ...
        try
        {
            ...
            return string.Format(WhereConditionFormat, FieldInfo.Name, DataHelper.ConvertValueToDefaultCulture(value, typeof(double)), op);
        }
        catch (Exception ex)
        {
            // Log exception
