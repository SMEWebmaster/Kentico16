...
public partial class CMSModules_AdminControls_Controls_Class_FieldEditor_DatabaseConfiguration : CMSUserControl
{
    ...
    public void Reload(string attributeName, bool enableSystemDDL)
    {
        ...
        if (FieldInfo != null)
        {
            ...
            LoadAndSelectAttributeType(selectedItem);
    ...
    {
        var types = FormHelper.GetFieldTypes(IsDocumentType, DevelopmentMode).ToHashSet(t => t);
    ...
    private void HandleRequiredVisiblity()
    {
        ...
        // Only not required can be made required in alternative forms, not vice versa.
