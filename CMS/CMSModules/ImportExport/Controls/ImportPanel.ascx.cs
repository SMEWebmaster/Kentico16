...
public partial class CMSModules_ImportExport_Controls_ImportPanel : CMSUserControl
{
            ...
            if (!RequestHelper.IsCallback())
            {
                ...
                if (Settings != null)
                {
                    if (SelectedNodeValue != CMS.DocumentEngine.TreeNode.OBJECT_TYPE)
                    {
                        ...
                        gvObjects.ButtonPressed += gvObjects_ButtonPressed;
                        gvObjects.OnPageChanged += gvObjects_PageChanged;
                        ...
                        gvTasks.ButtonPressed += gvTasks_ButtonPressed;
                        gvTasks.OnPageChanged += gvTasks_PageChanged;
                    }
                    else
                    {
    ...
    protected void gvObjects_ButtonPressed(object sender, EventArgs e)
    {
        SaveSelection();
    }


    protected void gvObjects_PageChanged(object sender, EventArgs e)
    {
        SaveSelection();
    }


    protected void gvTasks_ButtonPressed(object sender, EventArgs e)
    {
        SaveSelection();
    }


    protected void gvTasks_PageChanged(object sender, EventArgs e)
    {
        SaveSelection();
    }
