...
public partial class CMSModules_MediaLibrary_Controls_LiveControls_MediaGallery : CMSAdminControl
{
    ...
    {
        // Do not use inner control to get/set value because of special handling of this property in the inner control. 
        // CacheItemName in the inner control is composed from other properties.
        get;
        set;
    }
