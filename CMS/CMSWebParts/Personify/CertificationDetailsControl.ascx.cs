...
public partial class CMSWebParts_Personify_CertificationDetailsControl : CMSAbstractWebPart
{
    #region "Properties"
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            var ctrl = new Personify.WebControls.Profile.UI.CertificationDetailsControl();
