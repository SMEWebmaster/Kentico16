...
public partial class CMSWebParts_SME_DependentControls_EditMenu : CMS.Controls.EditMenu, IExtensibleEditMenu
	{
		 #region "Variables"
    ...
    /// Constructor
    /// </summary>
    public CMSWebParts_SME_DependentControls_EditMenu()
    {
        ShowSave = true;
        ShowCheckOut = false;
        ShowCheckIn = false;
        ShowUndoCheckOut = false;
        ShowApprove = true;
        ShowArchive = false;
