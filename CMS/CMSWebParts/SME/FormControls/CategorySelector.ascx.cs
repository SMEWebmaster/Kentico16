...
public partial class CMSWebParts_SME_FormControls_CategorySelector : FormEngineUserControl
{
    #region "Variables"
    ...
    public void ReloadData()
    {
        if (!StopProcessing)
        {
            ...
            selectCategory.GridName = "~/CMSWebParts/SME/FormControls/Categories.xml";
            ...
            selectCategory.SelectItemPageUrl = IsLiveSite ? "~/CMSWebParts/SME/FormControls/LiveCategorySelection.aspx" : "~/CMSModules/Categories/Dialogs/CategorySelection.aspx";
        }
    }
