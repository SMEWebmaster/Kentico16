<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiveCategorySelection.aspx.cs"
    Inherits="CMSWebParts_SME_FormControls_LiveCategorySelection" Title="Live Selection Dialog"
...
<asp:Content ID="cntActions" ContentPlaceHolderID="plcBeforeContent" runat="server" >
    <cms:CMSUpdatePanel runat="server" ID="pnlActions" Visible="false">
        <ContentTemplate>
            <div class="cms-edit-menu">
                <cms:HeaderActions ID="actionsElem" ShortID="a" runat="server" IsLiveSite="true" Visible="false" />
            </div>
        </ContentTemplate>
    </cms:CMSUpdatePanel>
</asp:Content>
