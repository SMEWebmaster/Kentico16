...
public partial class CMSWebParts_SME_SMEContributionList : CMSAbstractWebPart
{
 ...
 /// <summary>
    ...
    public String EventFilter
    {
        get
        {
            return ValidationHelper.GetString(GetValue("EventFilter"), list.EventFilter);
        }
        set
        {
            SetValue("EventFilter", value);
            list.EventFilter = value;
        }
    }

    /// Gets or sets the calendar to show dropdown filter.
    /// </summary>
    public bool ShowFilter
    {
         get
        {
            return ValidationHelper.GetBoolean(GetValue("ShowFilter"), list.ShowFilter);
        }
        set
        {
            SetValue("ShowFilter", value);
            list.ShowFilter = value;
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            list.EventFilter = EventFilter.ToString();
            list.ShowFilter = ShowFilter;
        }
    }
