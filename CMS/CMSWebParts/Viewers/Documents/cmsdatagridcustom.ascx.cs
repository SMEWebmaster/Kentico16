...
public partial class CMSWebParts_Viewers_Documents_cmsdatagridcustom : CMSAbstractWebPart
{
    #region "Variables"
    ...
    public override void OnContentLoaded()
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * FROM [dbo].[CMS_Category] where CategoryNamePath LIKE '%Events/%' ", con);
            ...
            try
            {
                ...
                newItem.Text = "All";
                newItem.Value = "";
                ddlEventType.Items.Add(newItem);
                ...
                while (ddlValues.Read())
                {
                    ...
                    //categoryPath = ddlValues["CategoryNamePath"].ToString();
                    ////string ="/Events";
                    //string displayName = categoryPath.Replace("/Events/", "");
                    //newItem.Text = displayName.Replace("/", " - ");
                    newItem.Text = ddlValues["CategoryName"].ToString();
                    newItem.Value = ddlValues["CategoryName"].ToString();
                    ddlEventType.Items.Add(newItem);
                }
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            if (hdnWhere.Value!="")
            {
                gridElem.WhereCondition = "EventCategory="+ "'" +hdnWhere.Value+ "'";/*"(DocumentID IN ( SELECT DocumentID FROM CMS_DocumentCategory WHERE CategoryID ="+"'"+hdnWhere.Value+"'"+ "))";*/
            }
            else
            {
