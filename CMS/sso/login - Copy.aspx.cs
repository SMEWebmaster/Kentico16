...
public partial class login : System.Web.UI.Page
{
    ...
    private void LoginMember(string Username, string Password, bool RememberMember)
    {
        try
        {
            var vendorPassword = ConfigurationManager.AppSettings["PersonifySSO_Password"];
            var vendorBlock = ConfigurationManager.AppSettings["PersonifySSO_Block"];
            ...
            var ssoRedirect = ConfigurationManager.AppSettings["AutoLoginPageUrl"] + "?vi=" + vendorId + "&vt=" + encryptedVendorToken;
            Session["LoginAttempted"] = true;
            Response.Write(ssoRedirect);
        }
